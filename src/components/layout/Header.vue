        ...
        <b-row>
          <b-col md="3" class="header-left">
            <router-link to="/" class="d-none d-md-block">
              <img
                v-if="isTestnet"
                src="../../styles/grit-images/grit-network-white-text.svg"
                class="header-logo"
              />
              <img
                v-else
...
export default {
  ...
  computed: {
    ...
    gradientClass() {
      return this.isTestnet ? "testnet-gradient" : "mainnet-gradient";
    }
  },
...
.header-gradinet::before {
  content: "";
  // background-image: url(../../styles/img/logo_bkg.png); image satin for header texture
  position: absolute;
  z-index: 0;
  top: 0;
  left: 0;
