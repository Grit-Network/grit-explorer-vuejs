  ...
  <div class="history">
    <div class="history-steps-wrapper">
      ...
      >
        ...
        <div class="history-date" :title="test.date">
    ...
    <Modal
      ...
      :title="
        translate(language, 'roundNumber', { number: selectedItemData.round })
      "
...
export default {
  ...
  methods: {
    ...
    getIconSrc(value) {
      if (value === true) return TrueIcon;

      if (value === false) return FalseIcon;
    },
